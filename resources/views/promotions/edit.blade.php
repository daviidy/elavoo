...
@section('title', 'Modififer une promo')
...
<div class="limiter">
  <div class="container-login100">
    <div class="wrap-login100">
      ...
      <form method="post" enctype="multipart/form-data" action="{{url('promotions', $promotion)}}" class="login100-form validate-form">
        ...
        <div class="wrap-input100 validate-input">
          <input class="input100" value="{{$promotion->value}}" type="number" name="value" required>
        ...
        <div class="wrap-input100">
          <select id="my-select1" multiple class="" name="category_id[]">
            ...
            <option {{$promotion->categories->contains($category->id) ? 'selected' : ''}} value="{{$category->id}}">{{$category->name}}</option>
            @endforeach
          </select>
