...
<h1 style="font-size:30px">Conditions d’utilisation de Elavoo</h1>
</div>
<div class="content">
  <h2>Objet</h2>
<p>Lors de votre utilisation de la plateforme Elavoo, nous pouvons être amenés à vous demander de nous communiquer des données à caractère personnel vous concernant.</p>
<p> <br> La plateforme  « Elavoo » (ci-après : « la plateforme ») permet à ses utilisateurs (ci-après : les « Clients ») de bénéficier d’un service de pressing et de blanchisserie par l’intermédiaire de livreurs (ci-après : les « chauffeurs ») qui récupèrent et ramènent à domicile les vêtements devant être nettoyés. La plateforme est disponible sur internet et sur supports mobiles.</p>
...
<ul>
  <li>A toute personne physique disposant de la pleine capacité juridique pour s’engager au titre des présentes conditions générales. La personne physique qui ne dispose pas de la pleine capacité juridique ne peut accéder à la plateforme et aux Services qu’avec l’accord de son représentant légal.</li>
...
<p><br>L’acceptation des présentes conditions générales est matérialisée par la validation de l’inscription à la plateforme. Cette acceptation ne peut être que pleine et entière. Toute adhésion sous réserve est considérée comme nulle et non avenue. Le Client qui n’accepte pas d’être lié par les présentes conditions générales ne doit pas accéder à la plateforme ni utiliser les Services.<br></p>
<h2>5. Inscription sur la Plateforme</h2>
<p>5.1 Pour s’inscrire sur la plateforme, le Client doit remplir un premier formulaire, en indiquant son nom, un mot de passe, e. mail. Toute inscription incomplète ne sera pas validée.</p>
<p><br>L’inscription entraîne automatiquement l’ouverture d’un compte au nom du Client (ci-après : le «Compte»), lui donnant accès à un espace personnel (ci-après : l’« Espace Personnel ») qui lui permet de gérer son utilisation des Services sous une forme et selon les moyens techniques que Elavoo juge les plus appropriés pour rendre lesdits Services.<br></p>
<p><br>5.2 Le Client peut accéder à tout moment à son Espace Personnel après s’être identifié à l’aide de son identifiant de connexion ainsi que de son mot de passe.<br></p>
<p><br>Le Client s’engage à utiliser personnellement les Services et à ne permettre à aucun tiers de les utiliser à sa place ou pour son compte, sauf à en supporter l’entière responsabilité. <br></p>
<p><br>Il est pareillement responsable du maintien de la confidentialité de son identifiant et de son mot de passe. Il doit immédiatement contacter Elavoo, aux coordonnées mentionnées à l’article 2 des présentes, s’il remarque que son Compte a été utilisé à son insu. Il reconnaît à Elavoo le droit de prendre toutes mesures appropriées en pareil cas.</p>
<p> <br> 5.3 Pour utiliser les Services, le Client doit remplir un deuxième formulaire, dans lequel il indique les adresses où il souhaite que ses vêtements soient récupérés ou ramenés. Le Client a la possibilité d’indiquer autant d’adresses qu’il le souhaite.</p>
<p> <br> 5.4 Le Client garantit que toutes les informations qu’il fournit aux fins de créations ou de mise à jour de son Compte sont exactes, à jour et sincères et ne sont entachées d’aucun caractère trompeur.</p>
<p><br> Il s’engage à mettre à jour ces informations dans son Espace Personnel en cas de modifications, afin qu’elles correspondent toujours aux critères susvisés</p>
<p><br> Le Client est informé et accepte que les informations saisies aux fins de création ou de mise à jour de son Compte vaillent preuve de son identité. Les informations saisies par le Client l’engagent dès leur validation.</p>

<h2>6. Description des Services</h2>
<p><br>Le Client a accès aux Services qui suivent, sous une forme et selon les fonctionnalités et moyens techniques qu’Elavoo juge les plus appropriés.<br></p>
<h3><br>6.1 Service de Pressing, laverie et de blanchisserie<br></h3>
<h4><br>6.1.1 Passation de la commande <br></h4>
<p><br> La liste des catégories de vêtements pouvant être confiées à Elavoo dans le cadre des Services est affichée dans la plateforme. Le Client reconnaît et accepte expressément que cette liste est exhaustive. En conséquence, tout article n’y figurant pas ne peut pas être confié lors d'une commande. <br></p>
<p><br><strong>Le Client choisit, au moyen d’un menu déroulant, un créneau d’une demi-heure, sur une plage s’étendant de 8h heures à 19 heures, au cours duquel un chauffeur peut venir récupérer les vêtements devant être nettoyés (ci-après : les «Articles»).</strong>  Il précise l’adresse, la date et l’heure auxquelles il souhaite que le rendez-vous ait lieu.</p>
...
Le Client peut accéder à ces données dans son Espace Personnel.</p>
<h2>9. Obligations du Client</h2>
<p><br>Sans préjudice des autres obligations prévues aux présentes, le Client s’engage à respecter les obligations qui suivent </p>
<p>9.1 Le Client s’engage, dans son usage des Services, à respecter les lois et règlements en vigueur et à ne pas porter atteinte aux droits de tiers ou à l’ordre public. </p>
<p>9.2 Le Client reconnaît avoir pris connaissance dans la plateforme des caractéristiques et contraintes, notamment techniques, de l’ensemble des Services. Il est seul responsable de son utilisation des Services. Le Client s’engage notamment, dans le cadre des commentaires qu’il est susceptible de publier pour évaluer les Services, à respecter les règles usuelles de politesse et de courtoisie. </p>
<p>9.3 Le Client s’engage à faire un usage strictement personnel des Services. Il s’interdit en conséquence de céder, concéder ou transférer tout ou partie de ses droits ou obligations au titre des présentes à un tiers, de quelque manière que ce soit. </p>
<p>9.4 Le Client s’engage à coopérer activement avec Elavoo et à lui fournir toutes les informations nécessaires à la bonne exécution des Services.
<br> Il s’engage notamment :</p>
<ul>
  <li>à donner des informations exactes concernant notamment les adresses de récupération et de retour, ainsi que la liste des Articles qu’il confie au chauffeur ;</li>
...
<p>13.3 Elavoo s’engage à procéder régulièrement à des contrôles afin de vérifier le fonctionnement et l’accessibilité de la plateforme. A ce titre, Elavoo se réserve la faculté d’interrompre momentanément l’accès à la plateforme pour des raisons de maintenance. De même, Elavoo ne saurait être tenue responsable des difficultés ou impossibilités momentanées d’accès à la plateforme qui auraient pour origine des circonstances qui lui sont extérieures, la force majeure, ou encore qui seraient dues à des perturbations des réseaux de télécommunication.</p>
<p>13.4 Elavoo ne garantit pas aux Clients que les Services, soumis à une recherche constante pour en améliorer notamment la performance et le progrès, seront totalement exempts d’erreurs, de vices ou défauts, que les Services, étant standard et nullement proposés à la seule intention d’un Client donné en fonction de ses propres contraintes personnelles, répondront spécifiquement à ses besoins et attentes.</p>
<p>13.5 En tout état de cause, la responsabilité susceptible d’être encourue par Elavoo au titre des présentes est expressément limitée aux seuls dommages directs avérés subis par le Client.</p>
<h2>14. Propriété intellectuelle d’Elavoo</h2>
<p>Les systèmes, logiciels, structures, infrastructures, bases de données et contenus de toute nature (textes, images, visuels, musiques, logos, marques, base de données, etc …) exploités par Elavoo au sein de la plateforme sont protégés par tous droits de propriété intellectuelle ou droits des producteurs de bases de données en vigueur. Tous désassemblages, décompilations, décryptages, extractions, réutilisations, copies et plus généralement, tous actes de reproduction, représentation, diffusion et utilisation de l’un quelconque de ces éléments, en tout ou partie, sans l’autorisation de Elavoo sont strictement interdits et pourront faire l’objet de poursuites judiciaires.</p>
<h2>15. Données à caractère personnel</h2>
<p>Elavoo pratique une politique de protection des données personnelles dont les caractéristiques sont explicitées dans le document intitulé « Charte relative à la protection des données à caractère personnel », dont le Client est expressément invité à prendre connaissance.</p>
<h2>16. Publicité</h2>
...
<h2>19. Durée des Services, désinscription</h2>
<p>Les Services sont souscrits pour une durée indéterminée. Le Client peut se désinscrire des Services à tout moment à travers son Espace Personnel. La désinscription est effective immédiatement ou, si des commandes sont en cours, dès le traitement complet de celles-ci. Elle entraîne la suppression automatique du Compte du Client.</p>
