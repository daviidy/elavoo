...
<div class="_29a1369d">
    <div class="_a46a6e7c">
        ...
        <div class="_2279adf0">
            @if(Auth::user()->isAdmin() && $user->isDeliver())
            <div class="_271fc7df">
                <div class="_b54a5bae">
                    <div class="_fd0d06e2">
        ...
        @if($user->isPressing() && $user->adresses)
        @foreach($user->adresses as $adress)
        <div style="width: 100%;margin-top: 1rem;" _ngcontent-iridium-us-c24="" class="course-summary-card row row-gap-medium catalog-card nanodegree-card ng-star-inserted">
                    ...
                    <div _ngcontent-iridium-us-c27="" class="card__inner card mb-0">
                        <div _ngcontent-iridium-us-c27="" class="card__inner--upper">
                            <div _ngcontent-iridium-us-c27="" class="image_wrapper hidden-md-down">
                                    <!---->
                                    <div _ngcontent-iridium-us-c27="" class="image-container ng-star-inserted" style="background-image: url(&quot;https://images.unsplash.com/photo-1475855581690-80accde3ae2b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60&quot;);">
                                    </div>

                                <!---->
                            </div>
                            <div _ngcontent-iridium-us-c27="" class="card-content">
                                <!----><span _ngcontent-iridium-us-c27="" class="tag tag--new card ng-star-inserted"><a id="showModal"> <strong style="color: #0274B6;">{{$adress->state}}, {{$adress->city}}</strong> </a></span>
                                <!---->
                                <div _ngcontent-iridium-us-c27="" class="category-wrapper">
                                    <!---->
                                    <h4 _ngcontent-iridium-us-c27="" class="category ng-star-inserted"> {{$adress->infos}}</h4>
                                </div>
